          ...
          <div className="fs-24">
            ...
            >
              ...
              <br />
                ...
                <li>
                  1. Перед стиркой молнии и пуговицы в изделиях обязательно
                ...
                <li>
                  3. Машинную стирку изделий из цветных полотен контрастных
                  цветов или с контрастной отделкой следует производить в теплой
                  воде (не выше 40 градусов) с использованием моющих средств для
                  цветных тканей, не содержащих отбеливающих веществ.
                </li>
                <li>
                  4. Не желательно для стирки использовать средства с
                  биодобавками (энзимами), так как они могут деформировать нить
                  и привести к расползанию ткани на швах.
                </li>
                <li>
                  5. Изделия из цветных полотен контрастных цветов или с
                  контрастной отделкой запрещается замачивать и кипятить, а
                  также оставлять мокрыми в сложенном виде.
                </li>
                <li>
                  6. Изделия с вышивкой, кружевом, набивным рисунком,
                  гладкокрашеные и «с эффектом мятости» следует подвергать
                  стирке и глажению с изнаночной стороны, чтобы не повредить
                  декоративные элементы, нанесенный рисунок и цвет изделия.
                </li>
                <li>
            ...
            >
              ...
              <ol>
                ...
                <li>
                  2. Льняные изделия после стирки могут дать усадку, в
                  нормируемых пределах.
                </li>
                <li>
                  3. При эксплуатации льняных изделий допускается образование
                  пуха и пиллинга, т.к. изделия производятся из натуральных
                  волокон.
                </li>
                <li>
